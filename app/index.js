    ...
    <View style={styles.container}>
      ...
      <View style={styles.main}>
        ...
        <View style={styles.nav}>
          ...
          <Button title="Extrato" onPress={() => router.navigate('/extrato')} />
          <Button title="Cartões" onPress={() => router.navigate('/cartoes')} />
          <Button title="Configurações" onPress={() => router.navigate('/configuracoes')} />
        </View>
      </View>
    </View>
  );
